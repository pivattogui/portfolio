...
void main() {
  ...
  float horizontalBlend = smoothstep(0.42, 0.92, gl_FragCoord.x / iResolution.x);
  float highlightBlend = smoothstep(0.22, 0.82, rgb.r) * horizontalBlend * 0.34;
  vec3 customColor = intensity * mix(uCustomColor, uSecondaryColor, highlightBlend);
...
export const Plasma: React.FC<PlasmaProps> = ({
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uSecondaryColor: { value: new Float32Array(secondaryColorRgb) },
  ...
  }, [color, secondaryColor, speed, direction, scale, opacity, mouseInteractive, renderScale, maxDpr, targetFps, iterations, lightMode]);
