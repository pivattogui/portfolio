...
const englishLabels = {
  ...
  aboutIndex: "01 / About", aboutTitle: ["I work where", "complexity lives."], yearsCount: "4.5+", years: "Years shaping reliable software products",
...
const portugueseLabels: { [K in keyof typeof englishLabels]: typeof englishLabels[K] extends readonly string[] ? readonly string[] : string } = {
  ...
  aboutIndex: "01 / Sobre", aboutTitle: ["Trabalho onde mora", "a complexidade."], yearsCount: "4,5+", years: "Anos construindo produtos de software confiáveis",
